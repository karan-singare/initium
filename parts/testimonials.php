    ...
    <div class="testimonials">
      <h1 class="testimonials__heading heading__primary">Testimonials</h1>
      <div class="testimonials__content">
        <div class="testimonial">
          <div class="testimonial__content">
            INITIUM provides great platform to learn, share knowledge and contribute to the Mining Society.
          </div>
          <div class="testimonial__author">
            <div class="testimonial__photo">
              <img src="images/profile/ncd.jpeg" alt="">
            </div>
            <div class="testimonial__name">
              <h4 class="heading-4">Professor Netai Chandra Dey</h4>
              <h5 class="heading-5">Faculty Convenor <br>INITIUM 6.0</h5>
            </div>
          </div>
        </div>
        <div class="testimonial">
          ...
          <div class="testimonial__author">
            ...
            <div class="testimonial__name">
              ...
              <h5 class="heading-5">Convenor INITIUM 4.0</h5>
            </div>
          </div>
        </div>
        <div class="testimonial">
        ...
        <div class="testimonial">
          <div class="testimonial__content">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque similique fugit quis magnam. Labore, dicta laborum explicabo, sit
          </div>
          <div class="testimonial__author">
            <div class="testimonial__photo">
              <img src="images/profile/team-1.jpg" alt="">
